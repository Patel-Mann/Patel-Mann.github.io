---
layout: post
title: "Notflix: Distributed streaming service"
categories: junk
author:
- Mann Patel
- Ali Al Yasseen
- Guanhua Huang (Eric)
- Thi My Tuyen Tran (Esther)
meta: "Springfield"
modified_date: 2022-05-27
thumbnail: /assets/images/notflix/notflix.png
featured_image: /assets/images/notflix/notflix.png
description: "A multi-node, fault tolerant video streaming service demonstrating distributed systems: HTTP/rpc communication, primary backup replication with quorum commit, leader election, heartbeats with circuit breaker, and pre-leadership log sync for fault tolerance."
---
...
<img class="project-inline-image" src="/assets/images/notflix/Untitled-3.png" alt="Replication Diagram">
...
<img class="project-inline-image" src="/assets/images/notflix/Untitled-2.png" alt="Election Diagram">
...
<img class="project-inline-image" src="/assets/images/notflix/Untitled-4.png" alt="Consistency Diagram">
