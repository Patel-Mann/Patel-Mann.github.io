...
thumbnail: /assets/images/pdg-cia/pdg-cia-tool.gif
featured_image: /assets/images/pdg-cia/pdg-cia-tool.gif
description: "Built a PDG-based change impact analysis tool for Java 1.4 programs. The tool parses source code, constructs a dependency graph capturing control flow and data flow relationships, and performs reachability analysis to determine impact sets for any given line change."
---
